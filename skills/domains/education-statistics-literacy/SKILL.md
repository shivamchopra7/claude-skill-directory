...
description: Use AgentPMT external API to run the Federal and State Education Data Hub tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Federal and State Education Data Hub



## Tool Summary
- Use Cases: Education policy analysis,School performance benchmarking,Literacy and enrollment trends,Regional equity reporting,Program impact evaluation
- Agent Description: Natural language interface to World Bank education statistics. Query by country and education level, get enrollment rates, literacy, gender parity indices. Automatic disaggregation by gender and education level.
- Full Description: Unified education analytics tool for public datasets covering literacy, enrollment, completion, equity, accountability, and school performance. Supports natural-language queries and routes requests across education-focused sources to return usable comparisons by country, state, and region.

Use this skill when the user wants to run the Federal and State Education Data Hub tool through AgentPMT external endpoints.
...
- product_slug: education-statistics-literacy
...
- Product URL: https://www.agentpmt.com/marketplace/education-statistics-literacy
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980d5aa71cad8f61bf5b1a8/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980d5aa71cad8f61bf5b1a8 \
  --credits 500 \
  --parameters-json '{"action":"query_education_data","country_or_region":"<country_or_region>"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980d5aa71cad8f61bf5b1a8/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Federal and State Education Data Hub
parameters = {
  "action": "query_education_data",
  "country_or_region": "<country_or_region>"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980d5aa71cad8f61bf5b1a8\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980d5aa71cad8f61bf5b1a8/invoke",
    json={
