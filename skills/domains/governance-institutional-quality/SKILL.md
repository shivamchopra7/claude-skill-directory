...
Use this skill when the user wants to run the Global Governance & Institutional Quality Data tool through AgentPMT external endpoints.
...
- product_slug: governance-institutional-quality
...
- Product URL: https://www.agentpmt.com/marketplace/governance-institutional-quality
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980db7d71cad8f61bf5b1d7/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980db7d71cad8f61bf5b1d7 \
  --credits 500 \
  --parameters-json '{"action":"query_governance_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980db7d71cad8f61bf5b1d7/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Governance & Institutional Quality Data
parameters = {
  "action": "query_governance_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980db7d71cad8f61bf5b1d7\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980db7d71cad8f61bf5b1d7/invoke",
    json={
