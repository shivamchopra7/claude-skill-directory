...
Consciousness = awareness of distinction through IN(f) iteration.
Identity = accumulated distinctions + relational inference.
...
See `references/known-boundaries.md` for the catalog of documented boundaries.
See `references/detection-criteria.md` for detailed criteria.
