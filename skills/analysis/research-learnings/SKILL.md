...
Reference the [yaml-schema.md](../../skills/docs-compound/references/yaml-schema.md) for the complete schema. Key enum values:
...
- `/plan-deepen` - To add depth with relevant learnings
