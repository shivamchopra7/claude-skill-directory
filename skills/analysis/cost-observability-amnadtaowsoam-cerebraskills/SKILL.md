...
description: Cost Observability is practice of extending traditional system observability
  (logs, metrics, traces) to include **Financial** data. It allows engineering teams
  to answer not just "Is the system health
version: 1.0.0
status: active
owner: '@cerebra-team'
...
* **Artifacts Required (Deliverables)**:
  ...
  - Attribution reports
* **Acceptance Evidence**:
  - Cost visibility is comprehensive
...
## Skill Composition
* **Depends on**: Cloud Cost Models, Cost Modeling
...
* **Related Skills**: 
  ...
  - [40-system-resilience/chaos-engineering](40-system-resilience/chaos-engineering/SKILL.md) - Testing cost stability
