...
- **Yes, update changelog first (Recommended)** -- Delegate to a changelog management agent to analyze commits since the last release and update the CHANGELOG.md `[Unreleased]` section
- **No, continue with existing changelog** -- Skip changelog update and proceed to Step 6
