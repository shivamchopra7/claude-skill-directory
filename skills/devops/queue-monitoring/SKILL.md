---
id: SKL-queue-QUEUEMONITORING
name: Queue Monitoring
description: Comprehensive guide to monitoring message queues including RabbitMQ,
  Redis, and Kafka for production systems. This skill covers key metrics collection,
  health checks, alerting strategies, Grafana dash
version: 1.0.0
status: active
owner: '@cerebra-team'
...
## Anti-patterns
1. **Monitoring everything**: Only monitor what matters
2. **Too many alerts**: Alert on actionable issues only
3. **No alert cooldowns**: Implement cooldowns to prevent spam
4. **Ignoring context**: Include context in alerts
5. **No dashboards**: Create dashboards for visibility
6. **No documentation**: Document all monitoring setup
7. **Not testing alerts**: Test alert delivery regularly
8. **Ignoring trends**: Monitor trends, not just snapshots
