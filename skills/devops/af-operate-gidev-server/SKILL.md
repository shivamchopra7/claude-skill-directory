---
name: af-operate-gidev-server
description: Operate GiDev server infrastructure including worktrees, tmux sessions, and Caddy routing. Use when managing port allocation, running start-work/stop-work scripts, or configuring dev server services.
...
**For AWS/DNS/credentials:** Use `af-provision-infrastructure` instead.

## Skills Referenced

- **`af-provision-infrastructure`** - For AWS credentials, DNS, Doppler patterns
