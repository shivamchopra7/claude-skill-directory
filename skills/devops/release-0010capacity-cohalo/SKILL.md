...
name: release
description: >
  Coordinate a full CoHalo release across engineering verification, npm,
...
7. If running through CoHalo, you have issue context for status updates and follow-up task creation.
...
CoHalo now uses this release model:
...
- any release summary in CoHalo issue context
