...
cluster: cloud-azure
description: "Build and deploy serverless event-driven functions on Azure."
tags: ["azure-functions","serverless","faas"] 
dependencies: []
composes: []
similar_to: []
called_by: []
...
embedding_hint: "Build and deploy serverless event-driven functions on Azure."
---
