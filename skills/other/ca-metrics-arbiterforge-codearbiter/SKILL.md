...
1. **Invoke the helper.** Call the thin entry hook `metrics.py`, which wraps
   ...
   ```
   python3 "<plugin-root>/hooks/metrics.py" --root "<project-root>" || python "<plugin-root>/hooks/metrics.py" --root "<project-root>"
   ```
   ...
   ```
   python3 "<plugin-root>/hooks/metrics.py" --root "<project-root>" --window N || python "<plugin-root>/hooks/metrics.py" --root "<project-root>" --window N
   ```
