...
### Ecto Challenge (`/skill:phx-challenge ecto`)
...
### LiveView Challenge (`/skill:phx-challenge liveview`)
...
### PR Challenge (`/skill:phx-challenge pr`)
...
Run `/skill:phx-challenge [mode]` to initiate a rigorous review. The reviewer will not approve until all concerns are addressed with evidence.

Example workflow:

1. Run `/skill:phx-challenge ecto` after migration changes
