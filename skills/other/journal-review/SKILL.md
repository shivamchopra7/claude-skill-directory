...
- **Self-audit of your own draft.** Use `$paper-review-lite` or the heavier external `presubmit` CLI. This skill is for third-party referee work and produces output appropriate to send to a journal editor.
