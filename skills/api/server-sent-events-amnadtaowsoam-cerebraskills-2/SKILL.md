...
description: Server-Sent Events (SSE) enable servers to push updates to clients over
  HTTP. This guide covers implementation, use cases, and best practices for building
  real-time features using unidirectional event
version: 1.0.0
status: active
owner: '@cerebra-team'
...
## Skill Composition
* **Depends on**: HTTP Server (`01-foundations/api-design/`), Authentication (`10-authentication-authorization/`)
...
* **Conflicts with**: None
* **Related Skills**: [live-notifications](34-real-time-features/live-notifications/SKILL.md), [real-time-dashboard](34-real-time-features/real-time-dashboard/SKILL.md)
