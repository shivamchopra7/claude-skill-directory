...
description: 'GraphQL is a query language for APIs that enables clients to ask for
  exactly what they need and nothing more, featuring a strong typing system and self-documenting
  capabilities. GraphQL consists of: -'
version: 1.0.0
status: active
owner: '@cerebra-team'
