...
Use this skill when the user wants to run the Global Digital Economy & Connectivity Data tool through AgentPMT external endpoints.
...
- product_slug: digital-economy-technology
...
- Product URL: https://www.agentpmt.com/marketplace/digital-economy-technology
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980db8871cad8f61bf5b1d9/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980db8871cad8f61bf5b1d9 \
  --credits 500 \
  --parameters-json '{"action":"query_digital_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980db8871cad8f61bf5b1d9/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Digital Economy & Connectivity Data
parameters = {
  "action": "query_digital_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980db8871cad8f61bf5b1d9\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980db8871cad8f61bf5b1d9/invoke",
    json={
