---
name: dotnet-legacy-api-controllers
...
- `dotnet-cqrs-command-generator` - Generate commands for controllers
- `dotnet-cqrs-query-generator` - Generate queries for controllers
- `dotnet-clean-architecture` - Overall project structure
- `dotnet-result-pattern` - Handle command/query results
