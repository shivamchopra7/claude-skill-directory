...
description: LINE LIFF (LINE Front-end Framework) enables building web apps that run
  within the LINE app, with direct access to LINE APIs like profile, share messages,
  and send messages to chat. This is critical f
version: 1.0.0
status: active
owner: '@cerebra-team'
