...
- **Suggested command**: Which command to use (prefer: /delight, /animate, /extract, /bolder, /polish, /audit, /critique, /colorize, /adapt, /quieter, /clarify, /distill, /harden, /normalize, /onboard, /optimize — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /delight, /animate, /extract, /bolder, /polish, /audit, /critique, /colorize, /adapt, /quieter, /clarify, /distill, /harden, /normalize, /onboard, /optimize. You may also suggest other installed skills you're sure exist, but never invent commands.
