...
**What this component does:** Provides a reference catalog of code quality principles (SOLID, DRY, KISS, YAGNI), clean code practices, testing strategies, code review checklists, code smells, and refactoring techniques.

**Capabilities needed:**
- None (reference-only skill -- provides knowledge, does not require tool access)

**Adaptation guidance:**
- This is a passive knowledge skill loaded by feature-dev (Phase 6) and bug-killer (Phase 4.5 deep track)
- The code examples use TypeScript but the principles are language-agnostic
- Can be extended with language-specific quality rules relevant to your project
