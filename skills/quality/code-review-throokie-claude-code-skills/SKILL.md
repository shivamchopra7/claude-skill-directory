...
1. **Evaluator** runs review checklist
2. **Identifies** issues with severity
3. **Optimizer** addresses critical/major issues
4. **Evaluator** re-verifies fixes
5. **Repeat** until no critical/major issues
