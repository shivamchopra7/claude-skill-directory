...
description: 'Challenge a consequential idea with sealed independent perspectives, cross-review, and preserved dissent. Triggers: "challenge this idea", "compare independent proposals", "stress-test a one-way door".'
practices:
- design-by-contract
- llm-eval-harness
- adr
...
metadata:
  ...
  tier: judgment
  dependencies: []
output_contract: idea-challenge.v1 JSON validated by skills/dueling-idea-genies/scripts/validate-output.sh
---
# Dueling Idea Genies
