---
name: code-review
description: Use when code review is requested for a pull request - provides comprehensive review checking CLAUDE.md compliance, bugs, git history context, and code quality with confidence scoring
---
