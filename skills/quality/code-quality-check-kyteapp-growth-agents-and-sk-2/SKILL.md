...
## Goal
Audit a target (file set or directory) against `.gemini/checklists/code-quality-checklist.yaml` and deliver a Markdown report with evidence and actionable fixes.
