...
Task general-purpose: "Use the design-agent-native skill at ~/.claude/plugins/.../design-agent-native. Read SKILL.md and apply it to: [agent/tool sections of plan]"
...
<thinking>
Dynamically discover every available agent and run them ALL against the plan. Don't filter, don't skip, don't assume relevance. 40+ parallel subagents is fine. Use everything available.
</thinking>
...
2. **Run `/review-technical`** - Get feedback from reviewers on enhanced plan
