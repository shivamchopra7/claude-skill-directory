...
| --- | ---: | --- | --- |
| `Guest_count` | Required |  | (none) |
| `Budget_range` | Required |  | (none) |
| `Type_of_event` | Required |  | (none) |
| `Theme_and_mood` | Required |  | (none) |
| `Date_and_duration` | Required |  | (none) |
| `Any_non_negotiables` | Required |  | (none) |
| `Special_goals_or_outcomes` | Required |  | (none) |
| `Venue_or_location_context` | Required |  | (none) |
...
- Required text inputs:
  ...
  - `Date_and_duration`
  - `Any_non_negotiables`
  - `Special_goals_or_outcomes`
  - `Venue_or_location_context`
...
betterprompt generate 01985ec5-ffb8-7d78-b19f-e29db62bcac5 \
  ...
  --input Theme_and_mood=<value> \
  --input Date_and_duration=<value> \
  --input Any_non_negotiables=<value> \
  --input Special_goals_or_outcomes=<value> \
  --input Venue_or_location_context=<value> \
  --model gpt-4.1-mini \
  --options '{}'
```
