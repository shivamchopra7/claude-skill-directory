...
### Gemini CLI Provider (Preferred for Gemini models)

This project uses `ai-sdk-provider-gemini-cli` with OAuth authentication to leverage a Google AI Pro subscription. See [Gemini CLI Provider Reference](references/gemini-cli-provider.md) for full setup, models, and quota details.
...
When using Gemini models, always use this provider instead of the Vercel AI Gateway for Gemini. The AI Gateway is still preferred for OpenAI and Anthropic models.
...
- [Gemini CLI Provider](references/gemini-cli-provider.md) - Gemini via OAuth with Google AI Pro subscription
