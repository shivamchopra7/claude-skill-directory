...
description: Writes comprehensive product briefs and PRDs. Triggers when user needs to document product requirements, define features, or create product specifications.
---
...
1. **Discovery Questions** - I'll ask clarifying questions
2. **Structure Creation** - I'll organize information into PRD format
3. **Gap Analysis** - I'll identify missing information
4. **Draft Generation** - I'll write the complete PRD
5. **Iteration** - We'll refine based on your feedback
...
✅ **User-Centric** - Every feature tied to user needs
✅ **Measurable** - Clear success criteria
✅ **Prioritized** - Features ranked by importance
✅ **Realistic** - Scope appropriate for timeline
✅ **Actionable** - Clear enough for engineers to implement
...
## 4. Product Vision
[Vision statement and differentiation]
...
[Integration needs, performance, security, scalability]

## 8. Success Metrics
| Metric | Target | Timeline |
|--------|--------|----------|
| Active Users | 100 | Week 12 |
