...
# XLSX Skill (Create, Edit, Analyze, Visualize)
...
- Use `tmp/xlsx/` for intermediate files; delete when done.
- Write final artifacts under `output/xlsx/` when working in this repo.
