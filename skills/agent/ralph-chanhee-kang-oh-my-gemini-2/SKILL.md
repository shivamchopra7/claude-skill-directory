...
3. **Spawn appropriate architect**:
   ...
   ```
4. **Wait for verdict**
5. **If approved**: Run `/oh-my-gemini:cancel` to cleanly exit
...
- When FULLY complete AND Architect verified: Run `/oh-my-gemini:cancel` to cleanly exit and clean up all state files
