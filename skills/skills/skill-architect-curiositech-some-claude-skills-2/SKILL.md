...
| `scripts/check_self_contained.py` | Phantom reference and orphan file detector — scans all .md files for broken paths |
| `scripts/init_skill.py` | Skill scaffolder — creates directory with SKILL.md template, references/, scripts/ |
