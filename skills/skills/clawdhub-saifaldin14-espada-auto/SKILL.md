...
metadata: {"espada":{"requires":{"bins":["clawdhub"]},"install":[{"id":"node","kind":"node","package":"clawdhub","bins":["clawdhub"],"label":"Install ClawdHub CLI (npm)"}]}}
---
...
- Default workdir: cwd (falls back to Espada workspace); install dir: ./skills (override with --workdir / --dir / CLAWDHUB_WORKDIR)
