...
- **User-level skills** (~/.gemini-cli/skills/omc-learned/) - Portable across all your projects
...
Then ask for scope:
- **User-level** (~/.gemini-cli/skills/omc-learned/) - Available across all projects
...
- `/oh-my-gemini:local-skills-setup list` - Show detailed skill inventory
- `/oh-my-gemini:local-skills-setup add` - Start skill creation (invoke learner)
- `/oh-my-gemini:local-skills-setup scan` - Scan both skill directories
...
- Run `/oh-my-gemini:local-skills-setup scan` periodically to review your skill library
