...
Codex-native entry point for the `gemini-headless-evidence` operator skill.

The AgentOps source skill `../../skills/gemini-headless-evidence/SKILL.md` is the source of truth
