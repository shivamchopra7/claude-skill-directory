...
description: "Run codebase pattern extraction."
---

# codebase-pattern-extraction (Codex)

Codex-native entry point for the `codebase-pattern-extraction` operator skill.

The AgentOps source skill `../../skills/codebase-pattern-extraction/SKILL.md` is the source of truth
