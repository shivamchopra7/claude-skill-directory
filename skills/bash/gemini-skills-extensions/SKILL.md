...
Codex-native entry point for the `gemini-skills-extensions` operator skill.

The AgentOps source skill `../../skills/gemini-skills-extensions/SKILL.md` is the source of truth
