...
description: "Run codebase report."
---

# codebase-report (Codex)

Codex-native entry point for the `codebase-report` operator skill.

The AgentOps source skill `../../skills/codebase-report/SKILL.md` is the source of truth
