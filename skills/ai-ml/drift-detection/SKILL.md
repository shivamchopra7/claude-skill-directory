...
description: 'This is an **alias skill** so docs can reference `77-mlops-data-engineering/drift-detection`.
  In this repo, drift guidance is covered by: - `77-mlops-data-engineering/drift-detection-retraining`
  (trig'
version: 1.0.0
status: active
owner: '@cerebra-team'
