...
description: 'Model Bias occurs when an AI system produces results that are systematically
  prejudiced against certain individuals or groups. Fairness is the practice of ensuring
  that the model''s predictions do not '
version: 1.0.0
status: active
owner: '@cerebra-team'
