...
skillVersionId: 0196eca1-a713-7d81-bf73-3be15138a09c
---

## What it does

This prompt asks the AI to generate a curated set of common interview questions for a specified field and provide professional-but-conversational sample answers tailored to a given level of work experience. The expected result is a realistic, practice-ready Q&A list that highlights real-world application, strategic thinking, problem-solving, and lessons learned from past work, helping the user prepare responses that sound credible and experience-based rather than purely theoretical.
...
| --- | ---: | --- | --- |
| `Enter_major` | Required |  | (none) |
| `work_experience` | Required |  | (none) |
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0196eca1-a713-7d81-bf73-3be15138a09c`).

Command form:

```bash
betterprompt generate 0196eca1-a713-7d81-bf73-3be15138a09c \
  [--input <key>=<value>] \
  [--model <model>] \
