...
After writing the report, present a brief summary of what was generated. Prompt the user to choose:
- **Review report** -- Read the report back to the user
- **Commit changes** -- Suggest using the git-commit skill to commit outstanding changes
...
- **File reading/writing**: Writing the report file, reading git output
- **Shell execution**: Running git commands to gather change data
- **User interaction**: Choosing report location, selecting next steps
