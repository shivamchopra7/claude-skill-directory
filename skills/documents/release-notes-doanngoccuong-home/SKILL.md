...
name: release-notes
description: |
  Ghi chú phiên bản app PikaRobot: changelog, known issues, rollout status.
  TRIGGERS: "release notes", "changelog", "phiên bản mới", "what shipped", "app update".
  NOT FOR: Sprint details (→Sprint_Plans/), experiments (→Experiments/).
---
# Release Notes
