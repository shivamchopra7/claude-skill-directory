...
This section provides examples of well-written and poorly-written changelog entries to guide entry creation.
...
| Poor Entry | Why It Is Poor | Better Version |
|------------|----------------|----------------|
...
**What this component does:** Provides comprehensive Keep a Changelog formatting guidelines, category definitions, entry writing best practices with good/bad examples, and structural templates for CHANGELOG.md files.

**Capabilities needed:**
- None (reference-only skill -- provides knowledge, does not require tool access)

**Adaptation guidance:**
- This is a passive knowledge skill loaded by feature-dev (Phase 7), release-python-package (Step 5), and the changelog-manager agent
- The format follows the Keep a Changelog specification which is platform-agnostic
- Entry examples can be extended with domain-specific patterns
