---
id: SKL-output-OUTPUTTEMPLATES
name: Output Templates
description: Output templates are structured formats for project deliverables. They
  ensure consistency, completeness, and clear communication across all projects.
version: 1.0.0
status: active
owner: '@cerebra-team'
