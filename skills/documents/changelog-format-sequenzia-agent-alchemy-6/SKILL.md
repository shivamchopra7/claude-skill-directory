...
**What this component does:** Provides Keep a Changelog format guidelines and entry writing best practices for consistent changelog management.

**Capabilities needed:**
- File reading (to check existing CHANGELOG.md structure)
- File editing (to update CHANGELOG.md)

**Adaptation guidance:**
- This is a reference/knowledge skill with no external dependencies
- The inlined entry examples section (originally a separate reference file) provides comprehensive good/bad examples for all changelog categories
- Can be used standalone or loaded by other skills that need changelog formatting guidance
