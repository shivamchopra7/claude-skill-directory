...
- If `DOC_TYPE = basic-markdown`: Use the Markdown File Templates (see below)
...
- The markdown file templates reference is in `references/markdown-file-templates.md` (kept separate due to size)
