---
name: project-init
description: Initialize Windsurf project context for an existing repository by generating root and scoped AGENTS.md files plus supporting ARCHITECTURE.md and TESTING.md documentation.
---

# Project Init

Deep-scan an existing repository and generate Windsurf-ready context files.
...
Use `templates/root-agents.template.md` as the starting point.
...
Use `templates/service-agents.template.md`.
...
- Confirm `AGENTS.md` references line up with `.windsurf/skills/` and the shared Windsurf package layout
- Confirm no file contains Claude-specific runtime assumptions

## Integration

- Templates: `templates/root-agents.template.md`, `templates/service-agents.template.md`
