...
name: product-prds
description: |
  Lưu trữ PRD (Product Requirements Document) cho các tính năng PikaRobot.
  TRIGGERS: "PRD", "product requirements", "spec tính năng", "viết PRD mới", "requirements document".
  NOT FOR: Design mockups (→Design_Specs/), tech specs (→Tech_Architecture/).
---
# PRDs

## Overview
Quản lý PRDs cho dự án PikaRobot.
