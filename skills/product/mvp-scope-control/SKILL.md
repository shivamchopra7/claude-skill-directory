---
id: SKL-mvp-MVPSCOPECONTROL
name: Mvp Scope Control
description: MVP (Minimum Viable Product) scope control is the practice of defining
  and maintaining the minimal set of features needed to validate your core hypothesis.
  Effective scope control prevents feature cre
version: 1.0.0
status: active
owner: '@cerebra-team'
