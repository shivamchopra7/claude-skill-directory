...
name: product-demo
description: |
  Demo recordings, screenshots, product showcase cho PikaRobot.
  TRIGGERS: "product demo", "demo recording", "screenshot", "showcase", "video demo".
  NOT FOR: User testing (→1_Discover/User_Research/), metrics (→User_Metrics/).
---
# Product Demo

## Overview
Quản lý Product Demo cho dự án PikaRobot.
