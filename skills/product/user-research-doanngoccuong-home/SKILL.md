...
name: user-research
description: |
  Lưu trữ và phân tích user research cho PikaRobot: interviews, surveys, observations.
  TRIGGERS: "user research", "interview notes", "survey results", "phỏng vấn user", "parent feedback".
  NOT FOR: Quantitative metrics (→4_Measure/), feature spec (→2_Define/).
---
# User Research

## Overview
Quản lý User Research cho dự án PikaRobot.
