---
name: "Kubernetes Testing Patterns"
description: "Kubernetes deployment testing including manifest validation, Helm chart testing, pod health checks, network policy testing, and rollback verification."
version: 1.0.0
author: qaskills
license: MIT
tags: [kubernetes, k8s, helm, deployment, manifests]
...
1. **Assess the project** — Understand the tech stack (yaml, go, python) and existing test infrastructure
