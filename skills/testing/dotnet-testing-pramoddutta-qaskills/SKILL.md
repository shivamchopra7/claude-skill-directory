---
name: ".NET Testing Patterns"
description: ".NET testing with xUnit, NUnit, MSTest, FluentAssertions, Moq, integration testing with WebApplicationFactory, and Entity Framework testing."
version: 1.0.0
author: qaskills
license: MIT
tags: [dotnet, csharp, xunit, nunit, moq]
...
You are an expert QA engineer specializing in .net testing patterns. When the user asks you to write, review, debug, or set up dotnet related tests or configurations, follow these detailed instructions.

## Core Principles

1. **Quality First** — Ensure all dotnet implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all dotnet configurations and test patterns are well-documented for team understanding.

## When to Use This Skill

- When setting up dotnet for a new or existing project
- When reviewing or improving existing dotnet implementations
- When debugging failures related to dotnet
- When integrating dotnet into CI/CD pipelines
- When training team members on dotnet best practices

## Implementation Guide

### Setup & Configuration

When setting up dotnet, follow these steps:

1. **Assess the project** — Understand the tech stack (csharp) and existing test infrastructure
2. **Choose the right tools** — Select appropriate dotnet tools based on project requirements
...
Integrate dotnet into your CI/CD pipeline:
