---
name: "Advanced Mutation Testing"
description: "Advanced mutation testing using Stryker, PIT, and mutmut to measure test suite quality by introducing controlled mutations and tracking kill rates."
version: 1.0.0
author: qaskills
license: MIT
tags: [mutation-testing, stryker, pit, mutmut, quality]
testingTypes: [unit]
frameworks: [stryker]
...
1. **Quality First** — Ensure all mutation-testing implementations follow industry best practices and produce reliable, maintainable results.
...
5. **Documentation** — Ensure all mutation-testing configurations and test patterns are well-documented for team understanding.
...
- When integrating mutation-testing into CI/CD pipelines
- When training team members on mutation-testing best practices
...
2. **Choose the right tools** — Select appropriate mutation-testing tools based on project requirements
