---
name: cypress
description: Write end-to-end tests with Cypress including browser automation, API testing, component testing, and visual regression. Use for E2E testing, integration testing, frontend QA automation, or cross-browser testing. Triggers on cypress, e2e, end-to-end, browser testing.
---
...
// Component test file: Button.cy.jsx
