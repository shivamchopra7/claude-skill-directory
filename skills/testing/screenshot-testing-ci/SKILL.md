---
name: "Screenshot Testing in CI"
description: "Integrating screenshot-based visual testing into CI pipelines with baseline management, review workflows, and cross-platform rendering comparison."
version: 1.0.0
author: qaskills
license: MIT
tags: [screenshot, ci, baseline, review, visual]
testingTypes: [visual]
...
You are an expert QA engineer specializing in screenshot testing in ci. When the user asks you to write, review, debug, or set up screenshot related tests or configurations, follow these detailed instructions.
