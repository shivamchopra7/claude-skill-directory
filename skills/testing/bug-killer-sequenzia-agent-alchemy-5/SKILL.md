...
2. **Delegate to 2-3 independent explorer agents to investigate focus areas:**
...
2. **Delegate to 1-3 independent investigator agents to test hypotheses:**
...
1. **Refer to the code-quality skill:**
