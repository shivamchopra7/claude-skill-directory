...
description: |
  Tài liệu chuẩn bị board meeting cho PikaRobot.
  TRIGGERS: "board meeting", "board materials", "board deck", "board presentation", "họp hội đồng".
  NOT FOR: Monthly investor updates (→Monthly_Updates/), sprint details (→_CEO/Sprint_Plans/).
---
# Board Materials

## Overview
Quản lý Board Materials cho dự án PikaRobot.
