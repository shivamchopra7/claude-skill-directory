...
description: >
  Write SEO-optimized blog posts, landing pages, and long-form page copy
  following Google's E-E-A-T and Helpful Content guidelines. Handles new
  content creation from a keyword, topic, or brief, and full-page rewrites.
  Use when asked to "write a blog post", "create a landing page", "write
  ...
  existing content (seo-geo-optimizer, content-quality-auditor), title tags
  or meta descriptions (meta-tags-optimizer), or keyword expansion
  (keyword-research) — those skills own their triggers.
---
