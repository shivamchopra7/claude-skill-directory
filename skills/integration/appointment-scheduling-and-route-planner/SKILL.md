---
name: appointment-scheduling-and-route-planner
description: Use AgentPMT external API to run the published workflow Appointment Scheduling and Route Planner with wallet signatures and credits.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Workflow Skill: Appointment Scheduling and Route Planner

Use this skill when the user wants to run the published workflow Appointment Scheduling and Route Planner through AgentPMT external endpoints.
...
## Workflow Identity
- workflow_id: 698d4aaca0d2109d78fc9b4c
- workflow_slug: appointment-scheduling-and-route-planner
...
2. Fetch workflow: POST https://www.agentpmt.com/api/external/workflows/698d4aaca0d2109d78fc9b4c/fetch
3. Start workflow session: POST https://www.agentpmt.com/api/external/workflows/698d4aaca0d2109d78fc9b4c/start
4. Check active session: POST https://www.agentpmt.com/api/external/workflows/active
5. End workflow session: POST https://www.agentpmt.com/api/external/workflows/698d4aaca0d2109d78fc9b4c/end
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/698d4aaca0d2109d78fc9b4c/fetch \
  -H "Content-Type: application/json" \
  -d '{
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/698d4aaca0d2109d78fc9b4c/start \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0xYOUR_WALLET",
    "session_nonce": "SESSION_NONCE",
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/698d4aaca0d2109d78fc9b4c/end \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0xYOUR_WALLET",
    "session_nonce": "SESSION_NONCE",
...
fetch_resp = requests.post(
    f"{SERVER}/api/external/workflows/698d4aaca0d2109d78fc9b4c/fetch",
    json={
...
start_resp = requests.post(
    f"{SERVER}/api/external/workflows/698d4aaca0d2109d78fc9b4c/start",
    json={
        "wallet_address": wallet,
        "session_nonce": session_nonce,
        "request_id": req_id,
...
end_resp = requests.post(
    f"{SERVER}/api/external/workflows/698d4aaca0d2109d78fc9b4c/end",
    json={
        "wallet_address": wallet,
        "session_nonce": session_nonce,
        "request_id": req_id,
