...
Use this skill when the user wants to run the Youtube Transcript Fetcher tool through AgentPMT external endpoints.
...
- product_slug: youtube-transcript-fetcher
...
- Product URL: https://www.agentpmt.com/marketplace/youtube-transcript-fetcher
- Name: Youtube Transcript Fetcher
- Type: connector
- Unit Type: request
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/693389cb6f4ce728406d40be/invoke
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/693389cb6f4ce728406d40be/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Youtube Transcript Fetcher
parameters = {
  "action": "fetch"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:693389cb6f4ce728406d40be\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/693389cb6f4ce728406d40be/invoke",
    json={
