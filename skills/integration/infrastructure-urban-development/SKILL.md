...
description: Use AgentPMT external API to run the Infrastructure, Mobility, and Housing Data Hub tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Infrastructure, Mobility, and Housing Data Hub



## Tool Summary
- Use Cases: Mobility and transit analysis,Infrastructure access benchmarking,Housing and permit trend analysis,Urban planning support,Regional development comparisons
...
- product_slug: infrastructure-urban-development
...
- Product URL: https://www.agentpmt.com/marketplace/infrastructure-urban-development
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980d8d871cad8f61bf5b1c4/invoke
...
### Example: query_infrastructure_data
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980d8d871cad8f61bf5b1c4 \
  --credits 500 \
  --parameters-json '{"action":"query_infrastructure_data","country_or_region":"<country_or_region>"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980d8d871cad8f61bf5b1c4/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Infrastructure, Mobility, and Housing Data Hub
parameters = {
  "action": "query_infrastructure_data",
  "country_or_region": "<country_or_region>"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980d8d871cad8f61bf5b1c4\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980d8d871cad8f61bf5b1c4/invoke",
    json={
