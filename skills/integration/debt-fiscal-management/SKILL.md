...
- Full Description: Explore the financial health of any country in the world. Look up national debt levels, government spending, tax revenue, and fiscal balances - all expressed as easy-to-understand ratios and percentages of GDP. Compare countries, track trends over time, and assess debt sustainability at a glance.

Use this skill when the user wants to run the Global Debt & Fiscal Explorer tool through AgentPMT external endpoints.
...
- product_slug: debt-fiscal-management
...
- Product URL: https://www.agentpmt.com/marketplace/debt-fiscal-management
- Name: Global Debt & Fiscal Explorer
- Type: data
- Unit Type: request
- Price (credits, external billable): 30
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980e39971cad8f61bf5b211/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980e39971cad8f61bf5b211 \
  --credits 500 \
  --parameters-json '{"action":"query_fiscal_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980e39971cad8f61bf5b211/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Debt & Fiscal Explorer
parameters = {
  "action": "query_fiscal_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980e39971cad8f61bf5b211\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980e39971cad8f61bf5b211/invoke",
    json={
