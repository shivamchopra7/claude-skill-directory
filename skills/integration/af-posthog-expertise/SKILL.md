---
name: af-posthog-expertise
description: |
  Use when integrating PostHog for product analytics, feature flags, and session replay.
  Covers SDK setup, feature flag patterns, event tracking conventions, Doppler credential
  management, and both greenfield and brownfield integration approaches.
...
- [GainInsight Standard Skill](../af-gaininsight-standard/SKILL.md)
