...
- product_slug: financial-sector-banking
...
- Product URL: https://www.agentpmt.com/marketplace/financial-sector-banking
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980e1d571cad8f61bf5b206/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980e1d571cad8f61bf5b206 \
  --credits 500 \
  --parameters-json '{"action":"query_financial_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980e1d571cad8f61bf5b206/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Financial Inclusion & Banking Data
parameters = {
  "action": "query_financial_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980e1d571cad8f61bf5b206\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980e1d571cad8f61bf5b206/invoke",
    json={
