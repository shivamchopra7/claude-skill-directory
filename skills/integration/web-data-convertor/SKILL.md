...
- product_slug: web-data-convertor
...
- Product URL: https://www.agentpmt.com/marketplace/web-data-convertor
- Name: Web Data Convertor
- Type: core utility
- Unit Type: request
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/69496d41b54506f955d789f1/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 69496d41b54506f955d789f1 \
  --credits 500 \
  --parameters-json '{"action":"convert-unix-to-date","timestamp":1}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/69496d41b54506f955d789f1/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Web Data Convertor
parameters = {
  "action": "convert-unix-to-date",
  "timestamp": 1
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:69496d41b54506f955d789f1\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/69496d41b54506f955d789f1/invoke",
    json={
