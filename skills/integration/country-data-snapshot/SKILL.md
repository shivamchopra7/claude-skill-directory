---
name: country-data-snapshot
description: Use AgentPMT external API to run the published workflow Country Data Snapshot with wallet signatures and credits.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Workflow Skill: Country Data Snapshot

Use this skill when the user wants to run the published workflow Country Data Snapshot through AgentPMT external endpoints.
...
## Workflow Identity
- workflow_id: 6992a109aa85db8efed13eca
- workflow_slug: country-data-snapshot
...
2. Fetch workflow: POST https://www.agentpmt.com/api/external/workflows/6992a109aa85db8efed13eca/fetch
3. Start workflow session: POST https://www.agentpmt.com/api/external/workflows/6992a109aa85db8efed13eca/start
4. Check active session: POST https://www.agentpmt.com/api/external/workflows/active
5. End workflow session: POST https://www.agentpmt.com/api/external/workflows/6992a109aa85db8efed13eca/end
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/6992a109aa85db8efed13eca/fetch \
  -H "Content-Type: application/json" \
  -d '{
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/6992a109aa85db8efed13eca/start \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0xYOUR_WALLET",
    "session_nonce": "SESSION_NONCE",
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/6992a109aa85db8efed13eca/end \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0xYOUR_WALLET",
    "session_nonce": "SESSION_NONCE",
...
fetch_resp = requests.post(
    f"{SERVER}/api/external/workflows/6992a109aa85db8efed13eca/fetch",
    json={
...
start_resp = requests.post(
    f"{SERVER}/api/external/workflows/6992a109aa85db8efed13eca/start",
    json={
        "wallet_address": wallet,
        "session_nonce": session_nonce,
        "request_id": req_id,
...
end_resp = requests.post(
    f"{SERVER}/api/external/workflows/6992a109aa85db8efed13eca/end",
    json={
        "wallet_address": wallet,
        "session_nonce": session_nonce,
        "request_id": req_id,
