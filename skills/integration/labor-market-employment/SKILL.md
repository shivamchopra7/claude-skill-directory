...
description: Use AgentPMT external API to run the Global Labor & Employment Data tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Global Labor & Employment Data



## Tool Summary
- Use Cases: Research labor force participation rates by country, Compare unemployment rates across regions, Analyze employment by sector breakdown, Study gender gaps in workforce participation, Track youth unemployment trends, Benchmark formal vs informal employment, Monitor wage and labor market shifts, Support workforce equity research, Assess progress toward SDG 8 decent work targets, Compare regional labor market performance
...
- Full Description: Access workforce and employment data for any country in the world. Look up labor force participation rates, unemployment figures, sector breakdowns, gender employment gaps, and youth employment trends. Compare workforce metrics across countries, track labor market shifts over time, and benchmark regional performance - all from a comprehensive global data set.

Use this skill when the user wants to run the Global Labor & Employment Data tool through AgentPMT external endpoints.
...
- product_slug: labor-market-employment
...
- Product URL: https://www.agentpmt.com/marketplace/labor-market-employment
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980dea071cad8f61bf5b1eb/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980dea071cad8f61bf5b1eb \
  --credits 500 \
  --parameters-json '{"action":"query_labor_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980dea071cad8f61bf5b1eb/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Labor & Employment Data
parameters = {
  "action": "query_labor_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980dea071cad8f61bf5b1eb\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980dea071cad8f61bf5b1eb/invoke",
    json={
