...
description: Use AgentPMT external API to run the Global Energy & Power Grid Data tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Global Energy & Power Grid Data



## Tool Summary
- Use Cases: Research electricity access rates by country, Compare renewable energy adoption across regions, Track fossil fuel vs clean energy trends, Analyze urban vs rural electricity gaps, Study energy consumption per capita, Monitor energy efficiency and intensity metrics, Assess progress toward SDG 7 clean energy targets, Compare energy mix breakdowns between countries, Research clean cooking fuel access, Evaluate energy transition progress over time
...
- product_slug: energy-access-production
...
- Product URL: https://www.agentpmt.com/marketplace/energy-access-production
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980de6b71cad8f61bf5b1e4/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980de6b71cad8f61bf5b1e4 \
  --credits 500 \
  --parameters-json '{"action":"query_energy_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980de6b71cad8f61bf5b1e4/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Energy & Power Grid Data
parameters = {
  "action": "query_energy_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980de6b71cad8f61bf5b1e4\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980de6b71cad8f61bf5b1e4/invoke",
    json={
