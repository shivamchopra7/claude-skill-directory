...
description: Use AgentPMT external API to run the Google Docs Connector tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Google Docs Connector



## Tool Summary
- Use Cases: document automation, report generation, template creation, collaborative editing, content management, proposal writing, meeting agenda creation, contract generation, documentation workflows, batch document processing
- Agent Description: Google Docs: create, edit, format documents. Tables, images, headers, page breaks. Export to PDF/DOCX/HTML. Share and manage permissions.
- Full Description: Comprehensive Google Docs management tool enabling AI agents to create edit format and share documents through OAuth authentication. Supports rich text formatting with bold italic underline strikethrough and custom fonts paragraph styling with alignment spacing and indentation table creation and manipulation image insertion from URLs headers footers and page breaks named ranges for bookmarking document export to multiple formats including PDF DOCX HTML and EPUB sharing and permission management and natural language document creation. Perfect for document automation report generation collaborative editing template creation and content management workflows.

Use this skill when the user wants to run the Google Docs Connector tool through AgentPMT external endpoints.
...
- product_slug: google-docs-connector
...
- Product URL: https://www.agentpmt.com/marketplace/google-docs-connector
- Name: Google Docs Connector
- Type: connector
- Unit Type: request
...
```json
{
  "action": {
    "type": "string",
    "description": "Use 'get_instructions' to retrieve documentation. Action to perform on Google Docs",
    "required": false,
  ...
  "location": {
    "type": "integer",
    "description": "Character index for insertions (1-based)",
    "required": false,
    "minimum": 1
  },
  "paragraph_style": {
    "type": "object",
    "description": "Paragraph styling including alignment, spacing, indentation",
    "required": false
  },
  "range_end": {
    "type": "integer",
    "description": "End index of range for formatting",
    "required": false,
    "minimum": 1
  },
  "range_start": {
    "type": "integer",
    "description": "Start index of range for formatting",
    "required": false,
    "minimum": 1
  },
  "replace_with": {
  ...
  "share_with": {
    "type": "array",
    "description": "List of users/groups to share document with",
    "required": false,
    "items": {
      "type": "object"
    }
  ...
  "text": {
    "type": "string",
    "description": "Text content for operations",
    "required": false
  },
  "text_style": {
    "type": "object",
    "description": "Text styling options including bold, italic, font size, colors",
    "required": false
  },
  "title": {
    "type": "string",
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6962fd6f4cf4309309cac7b0/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6962fd6f4cf4309309cac7b0 \
  --credits 500 \
  --parameters-json '{"action":"create_document"}'
```
...
# 2. Build parameters for Google Docs Connector
parameters = {
  "action": "create_document"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6962fd6f4cf4309309cac7b0\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6962fd6f4cf4309309cac7b0/invoke",
    json={
