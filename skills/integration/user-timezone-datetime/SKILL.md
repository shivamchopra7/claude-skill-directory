...
description: Use AgentPMT external API to run the Get Users Current Time / Date tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Get Users Current Time / Date



## Tool Summary
- Use Cases: Get current local time for a user, Build time aware reminders, Schedule messages in the user timezone, Add local timestamps to logs, Convert between UTC and user local time, Validate timezone configuration, Generate date strings for reports
...
Use this skill when the user wants to run the Get Users Current Time / Date tool through AgentPMT external endpoints.
...
- product_slug: user-timezone-datetime
...
- Product URL: https://www.agentpmt.com/marketplace/user-timezone-datetime
...
- User Timezone (user_timezone) | type: other | required
  - help: Select your IANA timezone (e.g. US/Eastern, Europe/London, Asia/Tokyo).
  - connection_id: 698d297d2b32918aa8fe5590

### Invocation Steps
1. Optional discovery: GET https://www.agentpmt.com/api/external/tools
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6987b3363a2127a981e41238/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6987b3363a2127a981e41238 \
  --credits 500 \
  --parameters-json '{"action":"get_current_datetime"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6987b3363a2127a981e41238/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Get Users Current Time / Date
parameters = {
  "action": "get_current_datetime"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6987b3363a2127a981e41238\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6987b3363a2127a981e41238/invoke",
    json={
