---
name: x-integration
description: X (Twitter) integration for FFT_nano. Post tweets, like, reply, retweet, and quote. Use for setup, testing, or troubleshooting X functionality. Triggers on "setup x", "x integration", "twitter", "post tweet", "tweet".
---
...
| `FFT_NANO_ROOT` | `process.cwd()` | Project root directory |
...
| `logs/fft_nano.log` | Service logs (contains X operation logs) | Ignored |
