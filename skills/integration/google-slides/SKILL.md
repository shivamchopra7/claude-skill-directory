...
- Full Description: Build stunning presentations without ever opening a browser. Create slide decks from scratch, add text, images, tables, and shapes, apply custom styles, fill templates with dynamic data, and generate slide thumbnails - all from your workflow. Perfect for automating reports, pitch decks, and client deliverables.

Use this skill when the user wants to run the Google Slides tool through AgentPMT external endpoints.
...
- Product URL: https://www.agentpmt.com/marketplace/google-slides
- Name: Google Slides
- Type: connector
- Unit Type: request
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/69928f99aa85db8efed13eb7/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 69928f99aa85db8efed13eb7 \
  --credits 500 \
  --parameters-json '{"action":"create_presentation"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/69928f99aa85db8efed13eb7/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Google Slides
parameters = {
  "action": "create_presentation"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:69928f99aa85db8efed13eb7\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/69928f99aa85db8efed13eb7/invoke",
    json={
