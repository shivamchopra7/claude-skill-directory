...
- Product URL: https://www.agentpmt.com/marketplace/youtube-api
- Name: YouTube Channel Management
- Type: function
- Unit Type: request
- Price (credits, external billable): 1
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/697bf0c272d3d1646732c184/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 697bf0c272d3d1646732c184 \
  --credits 500 \
  --parameters-json '{"action":"upload_video"}'
```
...
# 2. Build parameters for YouTube Channel Management
parameters = {
  "action": "upload_video"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:697bf0c272d3d1646732c184\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/697bf0c272d3d1646732c184/invoke",
    json={
