...
description: Use AgentPMT external API to run the Global Health & Public Health Data tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Global Health & Public Health Data



## Tool Summary
- Use Cases: Research life expectancy by country, Compare infant and child mortality rates across regions, Track immunization coverage trends, Analyze health expenditure as percentage of GDP, Study infectious disease prevalence, Monitor maternal mortality rates, Benchmark health outcomes against WHO targets, Compare healthcare access across countries, Support public health policy research, Assess progress toward health-related SDG targets
- Agent Description: Query life expectancy, mortality rates, immunization coverage, health expenditure, infectious disease indicators, and demographic health data for any country or region. Supports WHO benchmark comparisons, regional averages, and time-series trends.
- Full Description: Explore health and public health data for any country in the world. Look up life expectancy, mortality rates, immunization coverage, health expenditure, infectious disease prevalence, and demographic health indicators. Compare health outcomes across countries, benchmark against WHO targets, and track progress on global health goals - all from a comprehensive global data set.

Use this skill when the user wants to run the Global Health & Public Health Data tool through AgentPMT external endpoints.
...
- product_slug: healthcare-demographics-data
...
- Product URL: https://www.agentpmt.com/marketplace/healthcare-demographics-data
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980d5d271cad8f61bf5b1ad/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980d5d271cad8f61bf5b1ad \
  --credits 500 \
  --parameters-json '{"action":"query_health_data","country_or_region":"<country_or_region>"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980d5d271cad8f61bf5b1ad/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Global Health & Public Health Data
parameters = {
  "action": "query_health_data",
  "country_or_region": "<country_or_region>"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980d5d271cad8f61bf5b1ad\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980d5d271cad8f61bf5b1ad/invoke",
    json={
