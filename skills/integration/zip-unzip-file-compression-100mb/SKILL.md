...
Use this skill when the user wants to run the Zip / Unzip - File Compression < 100MB tool through AgentPMT external endpoints.
...
- product_slug: zip-unzip-file-compression-100mb
...
- Product URL: https://www.agentpmt.com/marketplace/zip-unzip-file-compression-100mb
- Name: Zip / Unzip - File Compression < 100MB
- Type: core utility
- Unit Type: request
...
```json
{
  ...
  "filename": {
    "type": "string",
    "description": "Filename for gzip input/output.",
    "required": false
  }
}
```
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/695c372f767df5adfd9bc870/invoke
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/695c372f767df5adfd9bc870/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Zip / Unzip - File Compression < 100MB
parameters = {
  "action": "compress"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:695c372f767df5adfd9bc870\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/695c372f767df5adfd9bc870/invoke",
    json={
