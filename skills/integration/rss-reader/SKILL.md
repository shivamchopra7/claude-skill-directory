...
- Product URL: https://www.agentpmt.com/marketplace/rss-reader
- Name: RSS Reader
- Type: core utility
- Unit Type: request
...
```json
{
  ...
  "include_raw": {
    "type": "boolean",
    "description": "Include raw parsed feed payload.",
    "required": false
  },
  "timeout_seconds": {
    "type": "integer",
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/695c37e7767df5adfd9bc874/invoke
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/695c37e7767df5adfd9bc874/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for RSS Reader
parameters = {
  "action": "read"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:695c37e7767df5adfd9bc874\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/695c37e7767df5adfd9bc874/invoke",
    json={
