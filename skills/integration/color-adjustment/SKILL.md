...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 694de6f7ecea2b5619a17bdc \
  --credits 500 \
  --parameters-json '{"action":"color-hex-to-rgb"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/694de6f7ecea2b5619a17bdc/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Color Adjustment
parameters = {
  "action": "color-hex-to-rgb"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:694de6f7ecea2b5619a17bdc\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/694de6f7ecea2b5619a17bdc/invoke",
    json={
