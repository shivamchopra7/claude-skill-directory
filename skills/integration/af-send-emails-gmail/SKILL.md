---
name: af-send-emails-gmail
description: Send emails from Claude/AgentFlow via Gmail API with service account authentication. Use when composing messages, adding attachments, handling replies, or automating email workflows.
...
parent: ../README.md
related:
  - ../af-generate-quotations/SKILL.md
