---
name: bank-statement-ocr-and-account-reconciliation
description: Use AgentPMT external API to run the published workflow Bank Statement OCR and Account Reconciliation with wallet signatures and credits.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Workflow Skill: Bank Statement OCR and Account Reconciliation

Use this skill when the user wants to run the published workflow Bank Statement OCR and Account Reconciliation through AgentPMT external endpoints.
...
## Workflow Identity
- workflow_id: 69916466aa85db8efed1342f
- workflow_slug: bank-statement-ocr-and-account-reconciliation
...
2. Fetch workflow: POST https://www.agentpmt.com/api/external/workflows/69916466aa85db8efed1342f/fetch
3. Start workflow session: POST https://www.agentpmt.com/api/external/workflows/69916466aa85db8efed1342f/start
4. Check active session: POST https://www.agentpmt.com/api/external/workflows/active
5. End workflow session: POST https://www.agentpmt.com/api/external/workflows/69916466aa85db8efed1342f/end
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/69916466aa85db8efed1342f/fetch \
  -H "Content-Type: application/json" \
  -d '{
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/69916466aa85db8efed1342f/start \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0xYOUR_WALLET",
    "session_nonce": "SESSION_NONCE",
...
curl -s -X POST https://www.agentpmt.com/api/external/workflows/69916466aa85db8efed1342f/end \
  -H "Content-Type: application/json" \
  -d '{
    "wallet_address": "0xYOUR_WALLET",
    "session_nonce": "SESSION_NONCE",
...
fetch_resp = requests.post(
    f"{SERVER}/api/external/workflows/69916466aa85db8efed1342f/fetch",
    json={
...
start_resp = requests.post(
    f"{SERVER}/api/external/workflows/69916466aa85db8efed1342f/start",
    json={
        "wallet_address": wallet,
        "session_nonce": session_nonce,
        "request_id": req_id,
...
end_resp = requests.post(
    f"{SERVER}/api/external/workflows/69916466aa85db8efed1342f/end",
    json={
        "wallet_address": wallet,
        "session_nonce": session_nonce,
        "request_id": req_id,
