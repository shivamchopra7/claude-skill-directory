...
- product_slug: live-web-page-browser
...
- Product URL: https://www.agentpmt.com/marketplace/live-web-page-browser
- Name: Live Web Page Browser
- Type: core utility
- Unit Type: request
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/69644454288e0324fa542102/invoke
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/69644454288e0324fa542102/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Live Web Page Browser
parameters = {
  "action": "get_instructions"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:69644454288e0324fa542102\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/69644454288e0324fa542102/invoke",
    json={
