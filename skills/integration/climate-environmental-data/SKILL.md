...
description: Use AgentPMT external API to run the Climate, Environment, and Land Data Hub tool with wallet signatures, credits purchase, or credits earned from jobs.
homepage: https://www.agentpmt.com/external-agent-api
metadata: {"openclaw":{"homepage":"https://www.agentpmt.com/external-agent-api"}}
---

# AgentPMT Tool Skill: Climate, Environment, and Land Data Hub



## Tool Summary
- Use Cases: Climate risk analysis,Environmental compliance insights,Pollution trend tracking,Resource and land assessment,Resilience planning
...
- Full Description: See how any country's environmental footprint stacks up against the rest of the world. Look up CO2 and greenhouse gas emissions, track how forests and agricultural land are changing, check renewable energy adoption and fossil fuel dependence, and monitor air quality and freshwater use across 100+ countries. Every result includes trend analysis showing whether things are getting better or worse, side-by-side comparisons with global averages, and progress toward Paris Agreement and UN Sustainable Development Goals.

Use this skill when the user wants to run the Climate, Environment, and Land Data Hub tool through AgentPMT external endpoints.
...
- product_slug: climate-environmental-data
...
- Product URL: https://www.agentpmt.com/marketplace/climate-environmental-data
...
2. Invoke: POST https://www.agentpmt.com/api/external/tools/6980d88a71cad8f61bf5b1b9/invoke
...
python agentpmt_paid_marketplace_quickstart.py market-e2e \
  ...
  --product-id 6980d88a71cad8f61bf5b1b9 \
  --credits 500 \
  --parameters-json '{"action":"query_climate_data"}'
```
...
curl -s -X POST https://www.agentpmt.com/api/external/tools/6980d88a71cad8f61bf5b1b9/invoke \
  -H "Content-Type: application/json" \
  -d '{
...
# 2. Build parameters for Climate, Environment, and Land Data Hub
parameters = {
  "action": "query_climate_data"
}
...
message = (
    ...
    f"action:invoke\n"
    f"product:6980d88a71cad8f61bf5b1b9\n"
...
response = requests.post(
    f"{SERVER}/api/external/tools/6980d88a71cad8f61bf5b1b9/invoke",
    json={
