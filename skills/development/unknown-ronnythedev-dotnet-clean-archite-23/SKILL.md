---
name: dotnet-pipeline-behaviors
...
- `dotnet-cqrs-command-generator` - Commands that flow through behaviors
- `dotnet-cqrs-query-generator` - Queries that flow through behaviors
- `dotnet-result-pattern` - Result types used by behaviors
