...
- **File system access**: Read files to analyze existing architectural patterns in the codebase

### Adaptation Guidance

- This is a reference/knowledge skill that provides architectural guidance. It does not require parallel delegation or shell execution.
- When used by other skills (e.g., feature-dev), it supplies pattern knowledge to inform design decisions.
- Mermaid diagrams follow the technical-diagrams skill conventions for consistent styling.
