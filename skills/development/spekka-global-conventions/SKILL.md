...
description: Project structure, git workflow, and environment configuration standards. Use this when organizing files, managing dependencies, setting environment variables, or following version control practices. Maintains consistency across the video generation service.
---
