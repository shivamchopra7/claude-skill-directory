---
id: SKL-real-REALTIMEMONITORING
name: Real Time Monitoring
description: Real-time monitoring provides live visibility into IoT device status
  and sensor data. This guide covers dashboards, alerts, and WebSocket implementation
  for building monitoring systems that provide in
version: 1.0.0
status: active
owner: '@cerebra-team'
