...
**What this component does:** Creates git commits with conventional commit messages by analyzing staged changes.

**Capabilities needed:**
- Shell command execution (for git operations)

**Adaptation guidance:**
- This skill is highly portable — it primarily executes git commands
