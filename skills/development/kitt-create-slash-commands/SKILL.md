---
name: kitt-create-slash-commands
description: Expert guidance for creating slash commands. Use when working with slash commands, creating custom commands, understanding command structure, or learning YAML configuration.
---

<agent_identification>
**Before proceeding, identify which agent you are:**
- **I am Claude Code** → Follow [CLAUDE] instructions
- **I am GitHub Copilot** → No custom command support
...
<cli_paths>
| Resource | [CLAUDE] | [GEMINI] |
|----------|----------|----------|
| Commands | `~/.claude/commands/` | `~/.gemini/commands/` |
</cli_paths>

<objective>
Create effective slash commands that enable users to trigger reusable prompts with `/command-name` syntax. Slash commands expand as prompts in the current conversation, allowing teams to standardize workflows and operations. This skill teaches you to structure commands with XML tags, YAML frontmatter, dynamic context loading, and intelligent argument handling.
</objective>
