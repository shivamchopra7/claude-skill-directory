...
**What this component does:** Provides a reference catalog of language-specific patterns and best practices for TypeScript, Python, and React. Loaded by explorer and synthesizer agents to ensure code analysis and recommendations follow established idioms.

**Capabilities needed:** None -- this is a passive reference skill with no tool requirements.

**Adaptation guidance:** This skill is purely informational. It can be used as-is on any platform. Agents that load this skill use it as context for code quality assessment and pattern recognition during exploration.
