...
- `dotnet-domain-entity-generator` - Entity base classes
- `dotnet-ef-core-configuration` - Entity configuration
- `dotnet-jwt-authentication` - IUserContext for tracking user
- `dotnet-repository-pattern` - Repository methods with soft delete
