...
name: release
description: >
  Use when the user wants to prepare or ship a release — running the full
  pre-release gate of security audit, E2E tests, final review, and version
  bump before deploying to production (security audit → E2E tests → review →
  version bump → docs). Examples: "prepare a release", "cut a release",
  "ship version 2.0", "release to production", "we're ready to deploy, get
  this release-ready".
---
