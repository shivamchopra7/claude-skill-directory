---
name: gitrules-skill
description: Git safety protocol that prevents destructive operations and accidental data loss during version control workflows.
when_to_use: Before running git commands that may discard changes, rewrite history, or otherwise impact repository safety.
---
