...
**What this component does:** Automates git commit creation with conventional commit message format based on staged changes analysis.

**Capabilities needed:**
- Shell command execution (for git commands)
- User interaction / prompting (for commit message confirmation if needed)

**Adaptation guidance:**
- This skill stages all changes with `git add .` then analyzes the diff to generate a conventional commit message
- The bash commands are standard git operations that work in any shell environment
- Pre-commit hook handling is described — adapt to your harness's hook support
