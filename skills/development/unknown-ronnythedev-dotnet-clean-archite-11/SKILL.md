...
- `02-dotnet-cqrs-command-generator` - Generate commands for endpoints
- `03-dotnet-cqrs-query-generator` - Generate queries for endpoints
- `08-dotnet-result-pattern` - Handle endpoint results
- `12-dotnet-jwt-authentication` - Add authentication
- `13-dotnet-permission-authorization` - Add authorization
