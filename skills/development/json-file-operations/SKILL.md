...
```bash
python3 .plan/execute-script.py plan-marshall:json-file-operations:{operation} {file_path} [--field {field}] [--value '{value}']
```
...
```bash
# Read entire file
python3 .plan/execute-script.py plan-marshall:json-file-operations:manage-json-file read config.json

# Read specific field
python3 .plan/execute-script.py plan-marshall:json-file-operations:manage-json-file read-field config.json --field "database.host"

# Update field
python3 .plan/execute-script.py plan-marshall:json-file-operations:manage-json-file update-field config.json --field "database.port" --value '5432'

# Add to array
python3 .plan/execute-script.py plan-marshall:json-file-operations:manage-json-file add-entry config.json --field "servers" --value '"new-server"'

# Remove from array
python3 .plan/execute-script.py plan-marshall:json-file-operations:manage-json-file remove-entry config.json --field "servers" --value '"old-server"'
```
...
| Script | Notation |
|--------|----------|
| manage-json-file | `plan-marshall:json-file-operations` |
