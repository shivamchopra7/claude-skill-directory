...
**What this component does:** Provides language-specific patterns, idioms, and best practices for TypeScript, Python, and React development. Used as a knowledge reference by exploration and synthesis agents.

**Capabilities needed:** None (passive knowledge reference).

**Adaptation guidance:** This is a static knowledge skill with no tool dependencies or orchestration logic. It can be loaded directly by any agent that needs language pattern guidance. Content is framework-agnostic and requires no platform-specific adaptation.
