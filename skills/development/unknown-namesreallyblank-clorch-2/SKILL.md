...
name: refactor
description: >
  Use when the user wants to restructure or clean up existing code without
  changing its behavior — large-scale refactors, extracting modules, or
  paying down technical debt, with review and test-validation gates (analyze
  → plan → implement → review → validate). Examples: "refactor this module",
  "clean up this code", "extract this into its own module", "improve the
  architecture of this service", "reduce technical debt here".
---
