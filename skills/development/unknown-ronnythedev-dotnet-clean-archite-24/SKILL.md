...
- `dotnet-repository-pattern` - Implement repositories
- `dotnet-ef-core-configuration` - Map entities to database
- `dotnet-domain-events-generator` - Handle domain events
- `dotnet-result-pattern` - Error handling
