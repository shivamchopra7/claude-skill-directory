---
id: SKL-live-LIVENOTIFICATIONS
name: Live Notifications
description: 'Live notification systems deliver real-time updates to users via WebSocket,
  SSE, or Push API. This guide covers architecture, implementation, and best practices
  for building notification systems that '
version: 1.0.0
status: active
owner: '@cerebra-team'
