---
name: dotnet-domain-events-generator
...
- `dotnet-domain-entity-generator` - Entities that raise events
- `dotnet-pipeline-behaviors` - Event publishing behavior
- `dotnet-clean-architecture` - Infrastructure layer setup
- `dotnet-cqrs-command-generator` - Commands that trigger events
