...
## Integration Notes
**What this component does:** Provides a comprehensive reference of architectural patterns (MVC, Layered, Repository, Service Layer, Event-Driven, CQRS, Hexagonal, Microservices) with Mermaid diagrams, implementation tips, and a pattern selection guide.
**Capabilities needed:** None (pure knowledge/reference skill).
**Adaptation guidance:** This is a passive knowledge skill loaded during architecture design phases. It references the technical-diagrams skill conventions from core-tools for Mermaid diagram styling but does not require it as a runtime dependency.
