---
id: SKL-pair-PAIRPROGRAMMING
name: Pair Programming
description: Pair programming is a software development technique where two developers
  work together at one workstation. One writes code (driver) while the other reviews
  and guides (navigator). This practice impro
version: 1.0.0
status: active
owner: '@cerebra-team'
