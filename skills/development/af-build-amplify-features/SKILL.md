---
name: af-build-amplify-features
description: Build features with AWS Amplify Gen 2 across the four-tier architecture. Use when developing with AppSync, Lambda, or data modelling, configuring authentication, or deploying Amplify apps.
...
- [af-setup-gaininsight-stack](../af-setup-gaininsight-stack/SKILL.md) - Infrastructure setup
- [af-configure-test-frameworks](../af-configure-test-frameworks/SKILL.md) - Testing Lambda functions
