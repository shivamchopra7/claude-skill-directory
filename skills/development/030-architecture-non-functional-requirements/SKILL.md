...
For detailed guidance, examples, and constraints, see [references/030-architecture-non-functional-requirements.md](references/030-architecture-non-functional-requirements.md).
