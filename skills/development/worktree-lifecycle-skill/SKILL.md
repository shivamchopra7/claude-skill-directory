---
name: worktree-lifecycle-skill
description: 'CRITICAL: Use /createworktree command for worktree management. Never
  use manual git worktree commands. Ports are auto-calculated.'
---
