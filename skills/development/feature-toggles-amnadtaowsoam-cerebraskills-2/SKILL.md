---
id: SKL-feature-FEATURETOGGLES
name: Feature Toggles
description: Feature toggles are runtime switches that enable or disable features
  without deploying new code. They decouple deployment from release, enabling gradual
  rollouts, A/B testing, and emergency feature di
version: 1.0.0
status: active
owner: '@cerebra-team'
