...
**What this component does:** Provides language-specific coding patterns, idioms, and best practices for TypeScript, Python, and React. Serves as a reference for consistent code style across implementations.

**Origin:** Skill (reference/leaf node)

**Capabilities needed:**
- None (pure reference content, no tool or platform dependencies)

**Adaptation guidance:**
- This is a static reference skill with no tool invocations or orchestration. It can be used as-is in any harness that supports markdown-based skill loading.
- Content is language-specific patterns and code examples -- no platform-specific behavior to adapt.
