...
- `dotnet-repository-pattern` - Repository with specification support
- `dotnet-cqrs-query-generator` - Query handlers using specifications
- `dotnet-domain-entity-generator` - Entities queried by specifications
