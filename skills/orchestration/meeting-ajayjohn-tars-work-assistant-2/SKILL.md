...
Universal constraints from the core skill apply (date resolution, name normalization, wikilink mandate, task verification, journal persistence, frontmatter compliance). Additionally:
