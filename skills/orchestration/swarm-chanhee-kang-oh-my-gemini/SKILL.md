...
- **N** - Number of agents (1-5, enforced by Gemini CLI limit)
...
- User cancels via `/oh-my-gemini:cancel`
...
- **Max Agents:** 5 (enforced by Gemini CLI background task limit)
...
User can cancel via `/oh-my-gemini:cancel`:
