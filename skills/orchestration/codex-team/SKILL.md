...
- [references/codex-team.feature](references/codex-team.feature) — Executable spec: analyze file targets for disjoint scopes, spawn conflict-free wave, join before reaping results (soc-qk4b)
