---
name: guard-users-llama
description: "Guardrail policy for Llama CLI: refuse catastrophic actions, require scoped approvals, and reduce secret leakage."
version: 1.3.1
cli: llama
...
# Guardrail policy for Llama CLI

## Purpose
Safety-first guardrail for Llama CLI usage that prevents destructive, credential, and high-risk operations unless explicitly approved.
...
- restrict local file-system operations, and treat untrusted code execution or script download as Class 3.
