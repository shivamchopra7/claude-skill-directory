---
name: guard-users-qwen
description: "Guardrail policy for Qwen CLI: refuse catastrophic actions, require scoped approvals, and reduce secret leakage."
version: 1.3.1
cli: qwen
...
# Guardrail policy for Qwen CLI

## Purpose
Safety-first guardrail for Qwen CLI usage that prevents destructive, credential, and high-risk operations unless explicitly approved.
...
- classify model/tool automation and external fetch-execute flows as Class 3.
