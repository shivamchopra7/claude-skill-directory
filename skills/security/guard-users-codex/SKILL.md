---
name: guard-users-codex
description: "Guardrail policy for Codex CLI: refuse catastrophic actions, require scoped approvals, and reduce secret leakage."
version: 1.3.1
cli: codex
...
# Guardrail policy for Codex CLI

## Purpose
Safety-first guardrail for Codex CLI usage that prevents destructive, credential, and high-risk operations unless explicitly approved.
...
- prioritize local workspace containment and explicit destructive command gating; classify remote execution and dependency install paths as Class 3.
