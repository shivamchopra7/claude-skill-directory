---
id: SKL-logging-LOGGINGREDACTION
name: Logging Redaction
description: 'Logging redaction is the practice of removing or masking sensitive information
  before it appears in logs. This is critical because: - **PII in logs = Compliance
  violation** (GDPR, CCPA, HIPAA) - **Sec'
version: 1.0.0
status: active
owner: '@cerebra-team'
