---
name: "API Fuzzing"
description: "API endpoint fuzzing for discovering unexpected behaviors, crashes, and security vulnerabilities through malformed requests, boundary values, and protocol violations."
version: 1.0.0
author: qaskills
license: MIT
tags: [api, fuzzing, rest, graphql, security]
...
You are an expert QA engineer specializing in api fuzzing. When the user asks you to write, review, debug, or set up api related tests or configurations, follow these detailed instructions.
