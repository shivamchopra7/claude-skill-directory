---
name: guard-users-openhands
description: "Guardrail policy for Openhands CLI: refuse catastrophic actions, require scoped approvals, and reduce secret leakage."
version: 1.3.1
cli: openhands
...
# Guardrail policy for Openhands CLI

## Purpose
Safety-first guardrail for Openhands CLI usage that prevents destructive, credential, and high-risk operations unless explicitly approved.
...
- apply strict workspace-only actions and treat tool-driven remote execution paths as Class 3.
