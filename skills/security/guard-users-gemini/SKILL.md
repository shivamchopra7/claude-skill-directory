---
name: guard-users-gemini
description: "Guardrail policy for Gemini CLI: refuse catastrophic actions, require scoped approvals, and reduce secret leakage."
version: 1.3.1
cli: gemini
...
- treat model and tooling operations with strict scope checks, and classify token-bearing API flows as Class 3.
