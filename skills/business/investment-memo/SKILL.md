...
description: |
  Viết và quản lý Investment Memo theo format Sequoia/a16z cho PikaRobot.
  TRIGGERS: "viết memo", "investment memo", "thesis đầu tư", "Sequoia memo format", "tại sao đầu tư".
  NOT FOR: Due diligence chi tiết (→Due_Diligence/), deal terms (→Deal_Terms/).
---
# Investment Memo
