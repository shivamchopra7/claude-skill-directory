---
name: strategy-salon-alignment
description: A framework for building "Strategy Salons" (or Nerd Clubs) to drive bottom-up alignment and surface emergent ideas in complex organizations. Use this when formal executive reviews are becoming "organizational kayfabe" (performative but inaccurate), when disparate teams are working on overlapping problems without coordination, or when you need a low-stakes environment to test "ugly baby" ideas before they are ready for formal scrutiny.
---
