...
name: go-to-market
description: |
  Go-to-market strategy cho PikaRobot: distribution channels, launch plan, growth loops.
  TRIGGERS: "go to market", "GTM", "distribution", "launch strategy", "channels", "growth hack", "marketing".
  NOT FOR: Pricing (→05_FINANCIALS/), product features (→04/).
---
# Go To Market

## Overview
Quản lý Go To Market cho dự án PikaRobot.
