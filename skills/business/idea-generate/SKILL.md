...
**Rigor Pack integration:** When a P1/P2 idea has a Rigor Pack from Stage 5, the Rigor Pack content pre-populates the fact-find stage doc. This accelerates `/lp-do-fact-find`, but does not replace it. Cards still proceed through the normal `lp-do-fact-find → lp-do-analysis → lp-do-plan → lp-do-build` loop.
