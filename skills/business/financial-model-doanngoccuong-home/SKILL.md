...
description: |
  Financial projections và scenario modeling cho PikaRobot.
  TRIGGERS: "financial model", "projections", "revenue forecast", "P&L", "dự báo tài chính", "scenario analysis".
  NOT FOR: Unit economics detail (→Unit_Economics/), cap table (→Cap_Table/).
---
# Financial Model

## Overview
Quản lý Financial Model cho dự án PikaRobot.
