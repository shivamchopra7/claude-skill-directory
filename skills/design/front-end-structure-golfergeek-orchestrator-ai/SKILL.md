...
description: 'Build Vue 3 + Ionic front-end components following Orchestrator AI''s
  strict architecture: stores hold state only, services handle API calls with transport
  types, components use services and read store'
---
