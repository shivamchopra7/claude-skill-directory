...
description: |
  ...
  reportings, HTML landing pages, etc. There are 10 pre-set themes with colors/fonts
  that you can apply to any artifact, or generate a new theme on-the-fly.
license: Apache-2.0
metadata:
  author: anthropic
  version: "1.0"
...
1. **Show available themes**: Present the list of 10 themes below and ask which one to apply
2. **Ask for their choice**: Ask which theme to apply to the deck
3. **Wait for selection**: Get explicit confirmation about the chosen theme
4. **Apply the theme**: Once a theme has been chosen, read the theme file from `assets/themes/` and apply the selected theme's colors and fonts to the deck/artifact
